...
const ContextMenu: React.FC<ContextMenuProps> = ({ id, onSelectNode }) => {
  ...
  if (isLoading) {
    return (
      <Menu id={id} className={styles.contextMenu}>
        <Item disabled>{t('contextMenu.loading')}</Item>
      </Menu>
    );
  }
  ...
  return (
    <Menu id={id} className={styles.contextMenu}>
      {/* 普通选项 */}
      <Item className={styles.menuItem}>{t('contextMenu.copy')}</Item>
      <Item className={styles.menuItem}>{t('contextMenu.paste')}</Item>
      <Item className={styles.menuItem}>{t('contextMenu.delete')}</Item>
      <Separator />
      ...
      <Separator />
      <Item className={styles.menuItem}>{t('contextMenu.selectAll')}</Item>
      <Item className={styles.menuItem}>{t('contextMenu.undo')}</Item>
      <Item className={styles.menuItem}>{t('contextMenu.redo')}</Item>
    </Menu>
  );
};
